...
s01  = SubModule
  ...
  , clue = "Maybe simply by writing the thing down"
  , answer = Answer "Vertex 0" "Graph Int" "(==)"
...
s02  = SubModule
  ...
  , clue = "Maybe simply by writing the thing down"
  , answer = Answer "Overlay (Vertex 0) (Vertex 1)" "Graph Int" "(==)"
...
s03  = SubModule
  ...
  , clue = "Maybe simply by writing the thing down"
  , answer = Answer "Connect (Vertex 0) (Vertex 1)" "Graph Int" "(==)"
...
s04 = SubModule
  ...
  , answer = Answer "Connect (Vertex 0) (Connect (Vertex 1) (Vertex 2))" "Graph Int" "(===)"
