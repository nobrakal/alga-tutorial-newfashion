...
\begin{itemize}
	\item A single path, from a vertex 0 to a vertex 1 can be viewed as \emph{Connect (Vertex 0) (Vertex 1)} %TODO img
	\item A triangle, with an edge from vertex 0 to vertex 1, an edge from vertex 0 to vertex 2, and an edge from vertex 1 to vertex 2 can be viewed as \emph{Connect (Vertex 0) (Connect (Vertex 1) (Vertex 2))} %TODO img
\end{itemize}
